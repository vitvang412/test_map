...
document.addEventListener('DOMContentLoaded', function () {
    ...
    geolocate.on('geolocate', async function (e) {
        ...
        locationPopup = new goongjs.Popup({ offset: 12, closeButton: true, maxWidth: '300px' })
            .setLngLat([lng, lat])
    ...
    function buildLocPopupLoading() {
        return `<div class="lp lp--with-img">
            <div class="lp__img-wrap">
                <div class="lp__img-skeleton"></div>
            </div>
            <div class="lp__body">
                <div class="lp__top">
    ...
    function buildLocPopupFull(address, lat, lng, accuracy) {
        ...
        const d = 0.0012;
        const imgUrl = `https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/export`
            + `?bbox=${lng-d},${lat-d},${lng+d},${lat+d}&bboxSR=4326&imageSR=4326&size=520,200&format=jpg&f=image`;
        return `<div class="lp lp--with-img">
            <div class="lp__img-wrap">
                <div class="lp__img-skeleton"></div>
                <img class="lp__img" src="${imgUrl}" alt=""
                     onload="this.classList.add('lp__img--loaded');this.previousElementSibling.style.display='none'"
                     onerror="this.parentElement.style.display='none'" />
                <div class="lp__img-badge">
                    <svg viewBox="0 0 16 16" fill="none" stroke="#fff" stroke-width="1.8" width="10" height="10">
